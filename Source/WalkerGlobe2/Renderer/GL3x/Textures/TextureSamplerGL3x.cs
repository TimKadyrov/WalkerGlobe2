...
namespace WalkerGlobe2.Renderer.GL3x
{
    internal class TextureSamplerGL3x : TextureSampler
    {
                ...
                maximumAnistropy)
        {
            ...
            GL.SamplerParameterI(_name.Value, (SamplerParameterName)All.TextureMinFilter, ref glMinificationFilter);
            GL.SamplerParameterI(_name.Value, (SamplerParameterName)All.TextureMagFilter, ref glMagnificationFilter);
            GL.SamplerParameterI(_name.Value, (SamplerParameterName)All.TextureWrapS, ref glWrapS);
            GL.SamplerParameterI(_name.Value, (SamplerParameterName)All.TextureWrapT, ref glWrapT);
