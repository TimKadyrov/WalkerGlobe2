...
namespace WalkerGlobe2.Renderer.GL3x
{
    ...
    {
        public ContextGL3x(int width, int height, Action makeCurrent = null)
            : this(width, height)
        {
            _makeCurrentAction = makeCurrent;
        }

        private ContextGL3x(int width, int height)
        {
        ...
        public override void Draw(OpenTK.Graphics.OpenGL.PrimitiveType primitiveType, int offset, int count, DrawState drawState, SceneState sceneState)
        {
            ...
            if (indexBuffer != null)
            {
                GL.DrawRangeElements((OpenTK.Graphics.OpenGL.PrimitiveType)TypeConverterGL3x.To(primitiveType),
            ...
            {
                GL.DrawArrays((OpenTK.Graphics.OpenGL.PrimitiveType)TypeConverterGL3x.To(primitiveType), offset, count);
            }
        }

        public override void Draw(OpenTK.Graphics.OpenGL.PrimitiveType primitiveType, DrawState drawState, SceneState sceneState)
        {
            VerifyDraw(drawState, sceneState);
            ApplyBeforeDraw(drawState, sceneState);
            ...
            {
                GL.DrawArrays((OpenTK.Graphics.OpenGL.PrimitiveType)TypeConverterGL3x.To(primitiveType), 0,
        ...
        private Action _makeCurrentAction;
    }
}
