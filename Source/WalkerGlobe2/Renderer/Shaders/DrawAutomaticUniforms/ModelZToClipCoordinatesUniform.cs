...
namespace WalkerGlobe2.Renderer
{
    ...
    internal class GlobeModelZToClipCoordinatesUniform : DrawAutomaticUniform
    {
        public GlobeModelZToClipCoordinatesUniform(Uniform uniform)
        {
            _uniform = (Uniform<Matrix42<float>>)uniform;
        }
        ...
        public override void Set(Context context, DrawState drawState, SceneState sceneState)
        {
            _uniform.Value = Matrix42<float>.DoubleToFloat(sceneState.GlobeModelZToClipCoordinates);
        }
