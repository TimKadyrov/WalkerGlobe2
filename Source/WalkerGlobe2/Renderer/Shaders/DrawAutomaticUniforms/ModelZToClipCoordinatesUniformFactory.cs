...
namespace WalkerGlobe2.Renderer
{
    ...
    internal class GlobeModelZToClipCoordinatesUniformFactory : DrawAutomaticUniformFactory
    {
        #region DrawAutomaticUniformFactory Members

        public override string Name
        {
            get { return "og_globeModelZToClipCoordinates"; }
        }

        public override DrawAutomaticUniform Create(Uniform uniform)
        {
            return new GlobeModelZToClipCoordinatesUniform(uniform);
        }
