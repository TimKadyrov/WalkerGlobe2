...
namespace WalkerGlobe2.Renderer
{
    ...
    public abstract class Context
    {
        ...
        public abstract void Draw(OpenTK.Graphics.OpenGL.PrimitiveType primitiveType, int offset, int count, DrawState drawState, SceneState sceneState);
        public abstract void Draw(OpenTK.Graphics.OpenGL.PrimitiveType primitiveType, DrawState drawState, SceneState sceneState);
    }
}
