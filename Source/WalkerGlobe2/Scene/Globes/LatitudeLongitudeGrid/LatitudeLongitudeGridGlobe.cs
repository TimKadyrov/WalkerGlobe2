    ...
    public sealed class LatitudeLongitudeGridGlobe : IDisposable
    {
        public LatitudeLongitudeGridGlobe(Context context)
        {
            ...
            ShaderProgram sp = Device.CreateShaderProgram(
                EmbeddedResources.GetText("WalkerGlobe.Scene.Globes.LatitudeLongitudeGrid.Shaders.GlobeVS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Globes.LatitudeLongitudeGrid.Shaders.GlobeFS.glsl"));
