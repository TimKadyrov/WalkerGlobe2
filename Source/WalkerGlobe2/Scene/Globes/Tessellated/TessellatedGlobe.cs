    ...
    public sealed class TessellatedGlobe : IDisposable
    {
        public TessellatedGlobe()
        {
            ShaderProgram sp = Device.CreateShaderProgram(
                EmbeddedResources.GetText("WalkerGlobe.Scene.Globes.Tessellated.Shaders.GlobeVS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Globes.Tessellated.Shaders.GlobeFS.glsl"));
