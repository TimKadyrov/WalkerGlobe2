    ...
    public sealed class DayNightGlobe : IDisposable
    {
        ...
        public DayNightGlobe(Context context)
        {
            ...
            ShaderProgram sp = Device.CreateShaderProgram(
                EmbeddedResources.GetText("WalkerGlobe.Scene.Globes.DayNight.Shaders.GlobeVS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Globes.DayNight.Shaders.GlobeFS.glsl"));
