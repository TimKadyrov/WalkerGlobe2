        ...
        public void Render(Context context, SceneState sceneState)
        {
            ...
            if (Show)
            {
                ...
                if (ShowOutline)
                {
                    ...
                    context.Draw(OpenTK.Graphics.OpenGL.PrimitiveType.LineLoop, 0, 4, _drawStateLine, sceneState);
                }
                ...
                if (ShowFill)
                {
                    ...
                    // Pass 2:  Fill
                    //
                    context.Draw(OpenTK.Graphics.OpenGL.PrimitiveType.Triangles, 4, 6, _drawStateFill, sceneState);
                }
            }
        }
