...
namespace WalkerGlobe2.Scene
{
    ...
    {
        public BillboardCollection(Context context, bool attachedToGlobe)
            : this(context, 0, attachedToGlobe)
        {
        }

        public BillboardCollection(Context context, int capacity, bool attachedToGlobe)
        {
            ...
            ShaderProgram sp = Device.CreateShaderProgram(
                attachedToGlobe ?
                    EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.BillboardCollection.Shaders.BillboardsVS.glsl"):
                    EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.BillboardCollection.Shaders.SpaceBillboardsVS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.BillboardCollection.Shaders.BillboardsGS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.BillboardCollection.Shaders.BillboardsFS.glsl"));
        ...
        public void Render(Context context, SceneState sceneState)
        {
            ...
            if (Show)
            {
                ...
                if (_drawState.VertexArray != null)
                {
                    ...
                    context.Draw(OpenTK.Graphics.OpenGL.PrimitiveType.Points, _drawState, sceneState);
                }
            }
        }
