        ...
        public void Set(Context context, Mesh mesh)
        {
            ...
            if (_drawState.ShaderProgram == null)
            {
                _drawState.ShaderProgram = Device.CreateShaderProgram(
                    EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.Polyline.OutlinedPolylineGeometryShader.PolylineVS.glsl"),
                    EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.Polyline.OutlinedPolylineGeometryShader.PolylineGS.glsl"),
                    EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.Polyline.OutlinedPolylineGeometryShader.PolylineFS.glsl"));
