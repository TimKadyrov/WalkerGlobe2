    ...
    public sealed class Wireframe : IDisposable
    {
        public Wireframe(Context context, Mesh mesh)
        {
            ...
            ShaderProgram sp = Device.CreateShaderProgram(
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.Wireframe.Shaders.WireframeVS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.Wireframe.Shaders.WireframeGS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.Wireframe.Shaders.WireframeFS.glsl"));
        ...
        private readonly OpenTK.Graphics.OpenGL.PrimitiveType _primitiveType;
    }
}