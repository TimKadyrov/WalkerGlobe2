...
namespace WalkerGlobe2.Scene
{
    ...
    {
        public Polygon(Context context, Ellipsoid globeShape, IEnumerable<Vector3D> positions, float rotanglez)
        {
            ...
            //
            result = TriangleMeshSubdivision.Compute(cleanPositions, indices, Trig.ToRadians(1));
            ...
            ShaderProgram sp = Device.CreateShaderProgram(
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.Polygon.Shaders.PolygonVS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.Polygon.Shaders.PolygonFS.glsl"));
        ...
        private  Uniform<Vector4F> _colorUniform;
