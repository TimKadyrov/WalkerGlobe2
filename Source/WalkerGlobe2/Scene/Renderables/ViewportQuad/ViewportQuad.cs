    ...
    public sealed class ViewportQuad : IDisposable
    {
        public ViewportQuad(Context context, string fs)
        {
            ...
            _drawState.ShaderProgram = Device.CreateShaderProgram(
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.ViewportQuad.Shaders.ViewportQuadVS.glsl"),
                fs == null ? EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.ViewportQuad.Shaders.ViewportQuadFS.glsl") : fs);
        ...
        public void Render(Context context, SceneState sceneState)
        {
            ...
            context.Draw(OpenTK.Graphics.OpenGL.PrimitiveType.TriangleStrip, _drawState, sceneState);
        }
