    ...
    public sealed class PolylineOnTerrain : IDisposable
    {
        public PolylineOnTerrain()
        {
            _wallSP = Device.CreateShaderProgram(
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.PolylineOnTerrain.Shaders.PolylineOnTerrainWallVS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.PolylineOnTerrain.Shaders.PolylineOnTerrainWallGS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.PolylineOnTerrain.Shaders.PolylineOnTerrainWallFS.glsl"));

            _shadowVolumeSP = Device.CreateShaderProgram(
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.PolylineOnTerrain.Shaders.PolylineOnTerrainShadowVolumeVS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.PolylineOnTerrain.Shaders.PolylineOnTerrainShadowVolumeGS.glsl"),
                EmbeddedResources.GetText("WalkerGlobe.Scene.Renderables.PolylineOnTerrain.Shaders.PolylineOnTerrainShadowVolumeFS.glsl"));
        }
        ...
        public void Set(Context context, IList<Vector3D> positions)
        {
            ...
            wallMesh.PrimitiveType = OpenTK.Graphics.OpenGL.PrimitiveType.TriangleStrip;
            ...
            lineMesh.PrimitiveType = OpenTK.Graphics.OpenGL.PrimitiveType.LineStrip;
        ...
        public void Render(Context context, SceneState sceneState, Texture2D silhouetteTexture, Texture2D depthTexture)
        {
            ...
            context.Draw(OpenTK.Graphics.OpenGL.PrimitiveType.LinesAdjacency, _wallDrawState, sceneState);
            ...
            context.TextureUnits[0].Texture = silhouetteTexture;
            context.TextureUnits[0].TextureSampler = Device.TextureSamplers.LinearClamp;
            context.Draw(OpenTK.Graphics.OpenGL.PrimitiveType.LinesAdjacency, _shadowVolumePassOne, sceneState);
            
            //
            // Render where the stencil is set; note that the stencil is also cleared 
            // where it is set.
            //
            context.Draw(OpenTK.Graphics.OpenGL.PrimitiveType.LinesAdjacency, _shadowVolumePassTwo, sceneState);
        }
