...
namespace WalkerGlobe2.Scene
{
    ...
    public sealed class CameraLookAtPoint : IDisposable
    {
        ...
        public Vector3D CenterPointStartUpdate
        {
            get { return _centerPoint; }
        ...
        private void UpdateCameraFromParameters()
        {
            ...
            eye = localToFixed * eye;
            eye += _centerPoint;
            _camera.Eye = eye;
            _camera.Up = localToFixed * up;
